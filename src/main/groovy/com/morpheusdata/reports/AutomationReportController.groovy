 ...
 */
class AutomationReportController implements PluginController {
	...
	List<Route> getRoutes() {
		[
			Route.build("/automationReport/example", "example", Permission.build("admin", "full")),
			Route.build("/automationReport/json", "json", Permission.build("admin", "full"))
		]
	}
